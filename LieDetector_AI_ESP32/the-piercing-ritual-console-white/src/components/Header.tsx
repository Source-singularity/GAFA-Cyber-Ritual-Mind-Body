    ...
    <header className="border-b-2 border-gray-300 pb-4 flex items-center justify-between z-10 bg-white relative">
     {/* ★ 插入这一行：点阵将覆盖在这个面板的所有文字和背景之上 */}
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl md:text-4xl mr-150 font-bold tracking-tighter uppercase glitch text-black" data-text="RITUAL CONSOLE: Subjectivity Verification">
          RITUAL CONSOLE: <span className="text-gray-400">Subjectivity Verification</span>
        </h1>
      </div>
